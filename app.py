...
@app.route('/makeACall',methods=['GET'])
def makeCall():
    print("hi")
    data = request.args
    print(data)
...
def makeFile(name,body,fileName,language):
    f = open(fileName, "a")
    text1 = "Hello, We are speaking from labour helpline."
    text2 = "A contractor named "+ name +" wants you for his work. He has left you a message which we will play now."    
    text3 = body
    text4 = "Thank you for listening. Goodbye"
